import { r as registerInstance, h, c as getElement } from './core-ae485377.js';
...
const LINK_COLOR = COLORS.teal[400];

const FONT_COLOR = COLORS.blue[500];
...
const UniversalHeader = class {
    ...
    render() {
        ...
        if (!this.isLoaded) {
            axios$1.get("https://cms.dev.lib.umich.edu/api/universalheader")
        ...
        const SiteLinks = (props, children) => [
            h("ul", null, props.data.map((d, i) => (h(LinkItem, { key: i + d.title }, h(Link, { kind: "list-medium", href: d.link, css: {
                    display: 'block',
                    padding: SPACING['M'],
                    ':hover': {
                        boxShadow: 'none'
                ...
                } }, h("span", null, d.title)), d.description && (h(LinkDescription, null, d.description))))))
        ];
        ...
        function Sites() {
            ...
            return (h(SitesContainer, null, h(SitesButton, { "aria-expanded": this_.isOpen }, h(HeaderText, null, h("span", null, "Explore"))), this_.isOpen && (h(Overlay, null, h(SitesLede, { "aria-role": "heading" }, h("span", null, "Explore what the library has to offer.")), h(Fragment, null, this_.isLoaded ? (h(LinksContainer, null, h(SiteLinks, { data: this_.data.primary }), h(SiteLinks, { data: this_.data.secondary }))) : (h(LoadingContainer, null, h(Loading, null))))))));
        }
        // return (
...
export { UniversalHeader as umichlib_universal_header };
